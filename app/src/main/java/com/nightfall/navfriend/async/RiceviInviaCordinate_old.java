 ...
 */
public class RiceviInviaCordinate_old extends AsyncTask<trasferCoordinates, Void, List<trasferCoordinates>> {
    Activity activity;
    GoogleMap map;
    trasferCoordinates position;

    public RiceviInviaCordinate_old(Activity activity, GoogleMap map){
